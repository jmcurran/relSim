...
#' itself with two further elements named loci and freqs. loci is a vector of
#' the 13-20 STR locus names. freqs is a list of 13-20 vectors, each vector
#' contains the allele frequencies.
