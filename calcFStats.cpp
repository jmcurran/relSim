...
List calcFStats(int nLoci, int nSubPop, const IntegerVector& NumLocusAlleles,
  ...
  for(nLoc = 0; nLoc < nLoci; nLoc++){
    ...
    // Rcout << "dFLocusNumerator: " << dFLocusNumerator << endl;
    // Rcout << "dFLocusDenominator: " << dFLocusDenominator << endl;
    ...
    dThetaNumerator += dThetaLocusNumerator;
    dThetaDenominator += dThetaLocusDenominator;
    
    dFNumerator += dFLocusNumerator;
    dFDenominator += dFLocusDenominator;
